...
<body>
    ...
    <form action="guarda_cobros.php" target="_blank" method="post">
        ...
        <form action="guarda_cobros.php" method="POST" onsubmit="return validarFormulario();">
                    ...
                    <ul style="border: 2px solid black; padding: 10px; border-radius: 10px; list-style-type: none;">
                        ...
                        ?>
                            <li>
                                ...
                                <form action="">
                                    <input type="hidden" id="dep_ft" name="dep_ft" placeholder="Ingrese importe">
                                </form>
                            </li>
        ...
        <a href="genera_recibo.php?movil=<?php echo $movil ?>
                                             
                                                &cant_viajes=<?php echo $can_viajes ?>
                                                &tot_voucher=<?php echo $total ?>                                                
                                                &total_a_pagar=<?php echo $total_a_pagar ?>" target="_blank" class="btn btn-danger">Genera Recibo y grabar</a>
