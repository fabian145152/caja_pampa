...
//(cod 1) Error deuda anterior menor a cero
...
if ($tot_voucher == 0 && $new_dep_ft == 0 && $debe_semanas > 0 && $deuda_anterior > 0 && $saldo_a_favor == 0 && $ventas > 0) {
    echo "<b>(cod 15) Semanas - deuda anterior - ventas</b>";
    exit;
}
//(cod 16) Deposito Solo
if ($tot_voucher == 0 && $new_dep_ft > 0 && $debe_semanas == 0 && $deuda_anterior == 0 && $saldo_a_favor == 0 && $ventas == 0) {
    echo "<b>(cod 16) Deposito Solo</b>";
    exit;
}
//(cod 17) Deposito - Ventas
if ($tot_voucher == 0 && $new_dep_ft > 0 && $debe_semanas == 0 && $deuda_anterior == 0 && $saldo_a_favor == 0 && $ventas > 0) {
    echo "<b>(cod 17) Deposito - Ventas</b>";
    exit;
}
//(cod 18) Deposito solo plata con deudas en 0
if ($tot_voucher == 0 && $new_dep_ft > 0 && $debe_semanas == 0 && $deuda_anterior == 0 && $saldo_a_favor == 0 && $ventas == 0) {
    echo "<b>(cod 18) Deposito solo plata con deudas en 0</b>";
    exit;
}
//(cod 19) Deposito - saldo a favor
if ($tot_voucher == 0 && $new_dep_ft > 0 && $debe_semanas == 0 && $deuda_anterior == 0 && $saldo_a_favor > 0 && $ventas == 0) {
    echo "<b>(cod 19) Deposito - saldo a favor</b>";
    exit;
}
//(cod 20) Deposito - saldo a favor - Ventas
if ($tot_voucher == 0 && $new_dep_ft > 0 && $debe_semanas == 0 && $deuda_anterior == 0 && $saldo_a_favor > 0 && $ventas > 0) {
    echo "<b>(cod 20) Deposito - saldo a favor - Ventas</b>";
    exit;
}
//(cod 21) Deposito - Deuda anterior
if ($tot_voucher == 0 && $new_dep_ft > 0 && $debe_semanas == 0 && $deuda_anterior > 0 && $saldo_a_favor == 0 && $ventas == 0) {
    echo "<b>(cod 21) Deposito - Deuda anterior</b>";
    exit;
}
//(cod 22) Deposito - Deuda anterior - Ventas
if ($tot_voucher == 0 && $new_dep_ft > 0 && $debe_semanas == 0 && $deuda_anterior > 0 && $saldo_a_favor == 0 && $ventas > 0) {
    echo "<b>(cod 22) Deposito - Deuda anterior - Ventas</b>";
    exit;
}
//(cod 23) Deposito - semanas
if ($tot_voucher == 0 && $new_dep_ft > 0 && $debe_semanas > 0 && $deuda_anterior == 0 && $saldo_a_favor == 0 && $ventas == 0) {
    echo "<b>(cod 23) Deposito - semanas</b>";
    exit;
}
//(cod 24) Deposito - Semanas - Ventas
if ($tot_voucher == 0 && $new_dep_ft > 0 && $debe_semanas > 0 && $deuda_anterior == 0 && $saldo_a_favor == 0 && $ventas > 0) {
    echo "<b>(cod 24) Deposito - Semanas - Ventas</b>";
    exit;
}
//(cod 25) Deposito - Semanas - Saldo a favor
if ($tot_voucher == 0 && $new_dep_ft > 0 && $debe_semanas > 0 && $deuda_anterior == 0 && $saldo_a_favor > 0 && $ventas == 0) {
    echo "<b>(cod 25) Deposito - Semanas - Saldo a favor</b>";
    exit;
}
//(cod 26) Deposito - semanas - saldo a favor - ventas
if ($tot_voucher == 0 && $new_dep_ft > 0 && $debe_semanas > 0 && $deuda_anterior == 0 && $saldo_a_favor > 0 && $ventas > 0) {
    echo "<b>(cod 26) Deposito - semanas - saldo a favor - ventas</b>";
    exit;
}
//(cod 27) Deposito - Semanas - Deuda anterior
if ($tot_voucher == 0 && $new_dep_ft > 0 && $debe_semanas > 0 && $deuda_anterior > 0 && $saldo_a_favor == 0 && $ventas == 0) {
    echo "<b>(cod 27) Deposito - Semanas - Deuda anterior</b>";
    exit;
}
//(cod 28) eposito - Semanas - Deuda anterior - Ventas
if ($tot_voucher == 0 && $new_dep_ft > 0 && $debe_semanas > 0 && $deuda_anterior > 0 && $saldo_a_favor == 0 && $ventas > 0) {
    echo "<b>(cod 28) eposito - Semanas - Deuda anterior - Ventas</b>";
    exit;
}
//(cod 29) Voucher solo
if ($tot_voucher > 0 && $new_dep_ft == 0 && $debe_semanas == 0 && $deuda_anterior == 0 && $saldo_a_favor == 0 && $ventas == 0) {
    echo "<b>(cod 29) Voucher solo</b>";
    exit;
}
//(cod 30) Voucher - Ventas
if ($tot_voucher > 0 && $new_dep_ft == 0 && $debe_semanas == 0 && $deuda_anterior == 0 && $saldo_a_favor == 0 && $ventas > 0) {
    echo "<b>(cod 30) Voucher - Ventas</b>";
    exit;
}
//(cod 31) Voucher - saldo a favor
if ($tot_voucher > 0 && $new_dep_ft == 0 && $debe_semanas == 0 && $deuda_anterior == 0 && $saldo_a_favor > 0 && $ventas == 0) {
    echo "<b>(cod 31) Voucher - saldo a favor</b>";
    exit;
}
//(cod 32) Voucher - Saldo a favor - Ventas
if ($tot_voucher > 0 && $new_dep_ft == 0 && $debe_semanas == 0 && $deuda_anterior == 0 && $saldo_a_favor > 0 && $ventas > 0) {
    echo "<b>(cod 32) Voucher - Saldo a favor - Ventas</b>";
    exit;
}
//(cod 33) voucher - Deuda anterior
if ($tot_voucher > 0 && $new_dep_ft == 0 && $debe_semanas == 0 && $deuda_anterior > 0 && $saldo_a_favor == 0 && $ventas == 0) {
    echo "<b>(cod 33) voucher - Deuda anterior</b>";
    exit;
}
//(cod 34) voucher - Deuda anterior - ventas
if ($tot_voucher > 0 && $new_dep_ft == 0 && $debe_semanas == 0 && $deuda_anterior > 0 && $saldo_a_favor == 0 && $ventas > 0) {
    echo "<b>(cod 34) voucher - Deuda anterior - ventas</b>";
    exit;
}
//(err cod 35) voucher - Deuda anterior - saldo a favor
if ($tot_voucher > 0 && $new_dep_ft == 0 && $debe_semanas == 0 && $deuda_anterior > 0 && $saldo_a_favor > 0 && $ventas == 0) {
    echo "<b>(err cod 35) voucher - Deuda anterior - saldo a favor</b>";
    exit;
}
//(err cod 36) voucher - Deuda anterior - saldo a favor - ventas
if ($tot_voucher > 0 && $new_dep_ft == 0 && $debe_semanas == 0 && $deuda_anterior > 0 && $saldo_a_favor > 0 && $ventas > 0) {
    echo "<b>(err cod 36) voucher - Deuda anterior - saldo a favor - ventas</b>";
    exit;
}
//(cod 37) voucher semanas
if ($tot_voucher > 0 && $new_dep_ft == 0 && $debe_semanas > 0 && $deuda_anterior == 0 && $saldo_a_favor == 0 && $ventas == 0) {
    echo "<b>(cod 37) voucher semanas</b>";
    exit;
}
//(cod 38) voucher - semanas - ventas
if ($tot_voucher > 0 && $new_dep_ft == 0 && $debe_semanas > 0 && $deuda_anterior == 0 && $saldo_a_favor == 0 && $ventas > 0) {
