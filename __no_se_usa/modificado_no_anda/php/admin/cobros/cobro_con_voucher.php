...
?>
    ...
    ?>
        <div class="contenedor">
            <!--
            <div class="recuadro">
                Viajes de la semana anterior: <?php // "<strong>" . $viajes_de_la_semana_anterior . "</strong>" 
                                                ?>
            </div>
            <div class="recuadro">
    ...
    -->
            ...
            <div class="recuadro">
                Descuento: <?php $total90 = $total * .9;
                            echo "<strong>" .  "$" . $total90  . "-" . "</strong>" ?>
            </div>
        </div>
    <?php
    }
    ...
    <form action="guarda_cobros_con_voucher.php" method="post" id="formulario" target="__blank">
        ...
        <div class="container">
                ...
                <ul style="border: 2px solid black; padding: 5px; border-radius: 10px; list-style-type: none;">
                    ...
                    if ($viajes_de_la_semana_anterior > 0) {
                        ?>
                            ...
                            <li>
                                <label for="viajes_nuevos">Voucher entregados: </label>
                                <input class="put" type="text" id="viajes_nuevos" name="viajes_nuevos" value="<?php echo $total_de_viajes_que_se_cobran
            ...
            <div>
                ...
                <ul style="border: 2px solid black; padding: 5px; border-radius: 10px; list-style-type: none;">
                    <input type="hidden" id="can_viajes" name="can_viajes" value="<?php $viajes_de_esta_semana ?>">
                    ...
                    <li>
                        ...
                        <?php
                        if ($para_movil < 0) {
                            $para_movil = $para_movil * -1;
                        } else {
                        ?>
                    <li>
                        <label class="mi-label">Debe abonarrrrrrrrrrrrr:</label>
                        <input type="text" id="paga_mov" name="paga_mov" value="<?php echo $para_movil ?>"
